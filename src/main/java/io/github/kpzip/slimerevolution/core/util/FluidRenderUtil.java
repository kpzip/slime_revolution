...
/*
This class has been taken from the mod "silents mechanisms"
and been slightly modified to work with official mappings
All credit for this class goes to the developers
of that mod.
*/
